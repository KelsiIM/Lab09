...
app.get("/show", (req, res) => {
    ...
    axios.get(getshow).then(results => {
        let singledata = results.data.show; // stores the key called 'show' within the returned JSON object
...
app.post("/create", (req, res) => {
    ...
    let epoint="http://jbusch.webhosting2.eeecs.qub.ac.uk/tvapi/?create&apikey=69729705";
